...
export default defineConfig({
  ...
  run: {
    tasks: {
      ...
      test: "vp test",
      ready: {
        command: ["vpr build", "node scripts/install-chrome-extension.mjs"],
        cache: false,
      },
      ...
      "chrome-ready-test": "node --test scripts/install-chrome-extension.test.mjs",
      verify: [
        "vpr moon-check",
        "vpr moon-prove",
        "vpr moon-test",
      ...
      package: {
        command: ["vpr build", "node scripts/package.mjs", "node --test scripts/package.test.mjs"],
        cache: false,
      },
    },
  },
